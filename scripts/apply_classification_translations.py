"""Apply Arabic cell translations to notebooks in Classification_Arabic/."""
...
AR_DIR = os.path.join(BASE, "Classification_Arabic")
...
def main() -> None:
    ...
    for fn in NOTEBOOKS:
        apply_notebook(fn)
    print("All classification notebooks updated.")
